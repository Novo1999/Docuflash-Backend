...
export class AddUserSettingsToUsers20260630000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "user_entity" ADD "defaultExpiry" character varying NOT NULL DEFAULT '7d'`)
    await queryRunner.query(`ALTER TABLE "user_entity" ADD "defaultPrivacy" character varying NOT NULL DEFAULT 'protected'`)
  }
